...
DEFAULT_CYCLOIDAL_ROLLING_FACTOR = 0.35
...
OPEN_SECTOR_MIN_SEGMENTS = 16
OPEN_SECTOR_SEGMENTS_PER_RADIAN = 160.0
...
# Legacy sampled cutter backend.
INVOLUTE_TEMPLATE_FILLET_SAFETY_FACTOR = 0.9
TEMPLATE_FILLET_ARC_POINT_COUNT = 7
CYCLOIDAL_TEMPLATE_INTERVALS = 14
SWEEP_PHASES_PER_TOOTH = 24
SWEEP_BLANK_ALLOWANCE_MODULES = 2.5
SWEEP_RACK_HALF_WIDTH_BLANK_FACTOR = 2.4
SWEEP_RACK_TOP_BLANK_FACTOR = 2.5
CUTTER_SIMPLIFICATION_FACTOR = 2e-4
RACK_SWEEP_MARGIN_FACTOR = CUTTER_SIMPLIFICATION_FACTOR
CUTTER_CONSERVATIVE_OFFSET_FACTOR = 1.75e-3
BUFFER_QUADRANT_SEGMENTS = 256
CUTTER_BUFFER_QUADRANT_SEGMENTS = 2
...
# The legacy sampled cutter sweep accumulates a pose-discretization allowance
# across tooth regions. Keep that compatibility budget bounded instead of
# letting it grow without limit with tooth count.
SAMPLED_SWEEP_MAX_OVERLAP_ALLOWANCE = 32
